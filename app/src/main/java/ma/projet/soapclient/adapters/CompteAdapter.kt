package ma.projet.soapclient.adapters
...
class CompteAdapter : RecyclerView.Adapter<CompteAdapter.CompteViewHolder>() {
    ...
    /**
     * Mise à jour complète de la liste des comptes
     */
    ...
    /**
     * Suppression d’un compte dans la liste
     */
    ...
    fun replaceCompte(compte: Compte) {
        val position = comptes.indexOfFirst { it.id == compte.id }
        if (position >= 0) {
            comptes[position] = compte
    ...
    /**
     * ViewHolder : représente une cellule de la liste
     */
    inner class CompteViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        /**
         * Remplit les vues avec les données du compte
         */
